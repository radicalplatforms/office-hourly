<template>
  ...
  <div>
    ...
    <div class="xl:pl-72">
      ...
      <div
        class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-6 border-b border-accent/5 bg-primary px-4 shadow-sm sm:px-6 lg:px-8"
      >
        <button
          type="button"
          class="-m-2.5 p-2.5 text-neutral xl:hidden"
        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
          <form class="flex flex-1" action="#" method="GET">
            ...
            <div class="relative w-full">
              ...
              <input
                id="search-field"
                class="block h-full w-full border-0 bg-transparent py-0 pl-8 pr-0 text-neutral focus:ring-0 sm:text-sm"
                placeholder="Search..."
                type="search"
                name="search"
              />
          ...
          >
            <div class="min-w-0 flex-auto">
              <div class="flex items-center gap-x-2">
                ...
                <h2
                  class="min-w-0 text-sm font-semibold leading-6 text-neutral"
                >
                  <NuxtLink
                    :to="'/session/' + session.ref"
                    class="flex gap-x-2"
                  >
                    <span class="truncate">{{
